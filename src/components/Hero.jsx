...
export default function Hero() {
  return (
    <section id="home" className="relative overflow-hidden">
      {/* Parallax background glows - stronger speeds */}
      <ParallaxLayer speed={0.2} className="absolute -top-40 -left-40 h-80 w-80 rounded-full bg-fuchsia-400/30 blur-3xl -z-10" />
      <ParallaxLayer speed={0.14} className="absolute top-10 -right-20 h-96 w-96 rounded-full bg-cyan-400/30 blur-3xl -z-10" />
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 py-20 md:py-28">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative">
            ...
            <ParallaxLayer speed={0.28} className="pointer-events-none absolute -bottom-6 -left-6 h-28 w-28 rounded-xl bg-fuchsia-400/40 blur-2xl" />
            <ParallaxLayer speed={0.18} className="pointer-events-none absolute -top-6 -right-6 h-28 w-28 rounded-xl bg-cyan-400/40 blur-2xl" />
          </div>
        </div>
      </div>
    </section>
